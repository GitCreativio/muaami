  ...
  return (
    <section className="relative min-h-screen flex flex-col md:flex-row items-center justify-between px-6 md:px-16  py-16 bg-linear-to-br from-emerald-900 via-black to-gray-900 text-white overflow-hidden">
      ...
      >
        ...
        <Link href={'/products'} className="mt-4 bg-green-600 hover:bg-green-700 transition-all text-white px-6 py-3 rounded-full font-medium shadow-lg">
          Explore Our Drinks
        </Link>
      </motion.div>
      ...
      >
        ...
        <div className="absolute w-[70%] rotate-90 left-0 top-18  -z-10 opacity-40 bg-green-500 sm:w-[60%] md:w-[45%] lg:w-[50%] aspect-9/16 rounded-full overflow-hidden shadow-2xl border border-green-700">
         
        </div>
        <div className="absolute w-[70%] -rotate-50 left-0   -z-10 opacity-60  bg-green-500 sm:w-[60%] md:w-[45%] lg:w-[50%] aspect-9/16 rounded-full overflow-hidden shadow-2xl border border-green-700">
         
        </div>
        <div className="absolute w-[70%] rotate-50 right-0   -z-10 opacity-60  bg-green-500 sm:w-[60%] md:w-[45%] lg:w-[50%] aspect-9/16 rounded-full overflow-hidden shadow-2xl border border-green-700">
         
        </div>
        <div className="absolute w-[70%] rotate-90 right-0 top-18  -z-20  opacity-40 bg-green-500 sm:w-[60%] md:w-[45%] lg:w-[50%] aspect-9/16 rounded-full overflow-hidden shadow-2xl border border-green-700">
