...
export default function HeroSection() {
  return (
    <section className="relative bg-[url('/img.webp')] flex bg-linear-to-br min-h-screen from-emerald-900 via-black to-gray-900 flex-col md:flex-row items-center justify-between  px-6 md:px-16 lg:px-24 py-20 pt-40 sm:pt-32  bg-cover bg-center text-white overflow-hidden">
